...
class YOLOv8Seg:
    ...
    def __init__(self, onnx_model):
        ...
        self.classes = yaml_load(check_yaml("detection/train-yolov8n-seg_vn.yaml"))["names"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='detection/best.onnx')
            ...
            for img_file in os.listdir(person_path):
                ...
                if len(boxes) > 0:
                    ...
                    if keypoints is not None:
                        ...
                        aligned_img_path = os.path.join('detection/aligned_images', f"align_{num_success}.jpg")
